    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <?php
                    $find_id = "select post_id from admin_post where user_id = {$_SESSION['user_id']} ";
                ...
                <a href="mypostad.php?delete=<?php echo $post_id; ?>" class="btn btn-primary">Delete Post <span class="glyphicon"></span></a>
                <hr>
            <?php } } } } ?>
...
if(isset($_GET['delete'])){
    ...
    $del_user = "delete from admin_post where post_id = {$the_post_id} ";
